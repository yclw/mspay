...
type FuncDict func(ctx context.Context) (res []*Option, err error)
...
func GetFuncOptions(ctx context.Context, key string) (res []*Option, err error) {
	fun, ok := funcOptions[key]
	if !ok {
		err = ErrNotExistKey
		return
...
func LoadFuncOptions(ctx context.Context, fun *FuncOption) (res []*Option, err error) {
